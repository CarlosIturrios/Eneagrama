...
def register(request):
    ...
    return render(request, 'register.html', {'nombreMostrar':nombreMostrar})
...
def parteUno(request):
    ...
    return render(request, 'perfil_de_personalidad_parte_1.html', {'nombreMostrar':nombreMostrar})
...
def parteDos(request):
    ...
    nombreMostrar = request.session['nombre']
    return render(request, 'perfil_de_personalidad_parte_2.html', {'nombreMostrar':nombreMostrar})
...
def parteTres(request):
    ...
    nombreMostrar = request.session['nombre']
    return render(request, 'perfil_de_personalidad_parte_3.html', {'nombreMostrar':nombreMostrar})
...
def parteCuatro(request):
    ...
    nombreMostrar = request.session['nombre']
    return render(request, 'perfil_de_personalidad_parte_4.html', {'nombreMostrar':nombreMostrar})
...
def parteCinco(request):
    ...
    nombreMostrar = request.session['nombre']
    return render(request, 'perfil_de_personalidad_parte_5.html', {'nombreMostrar':nombreMostrar})
...
def parteSeis(request):
    ...
    nombreMostrar = request.session['nombre']
    return render(request, 'perfil_de_personalidad_parte_6.html', {'nombreMostrar':nombreMostrar})
...
def parteSiete(request):
    ...
    nombreMostrar = request.session['nombre']
    return render(request, 'perfil_de_personalidad_parte_7.html', {'nombreMostrar':nombreMostrar})